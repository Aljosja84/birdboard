<template>
    <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
        <h1 class="font-normal mb-12 text-center text-2xl text-default">Let's Start Something New</h1>
        <form @submit.prevent="submit">
            <div class="flex">
                ...
                <div class="flex-1 ml-4">
                    <div class="mb-4">
                        ...
                        <input type="text"
                               class="border border-grey-light mb-2 py-2 px-2 text-xs block w-full rounded"
            ...
            <footer class="flex justify-end">
                <button type="button" class="mr-4 text-default" @click="$modal.hide('new-project')">Cancel</button>
