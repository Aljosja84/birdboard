...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "h1",
        { staticClass: "font-normal mb-12 text-center text-2xl text-default" },
                ...
                [
                  ...
                  _vm._l(_vm.form.tasks, function(task) {
                    return _c("input", {
                      ...
                      staticClass:
                        "border border-grey-light mb-2 py-2 px-2 text-xs block w-full rounded",
...
function () {
  ...
  _createClass(BirdboardForm, [{
    ...
    value: function submit(endpoint) {
      return axios.post(endpoint, this)["catch"](this.onFail.bind(this)).then(this.onSuccess.bind(this));
    }
  }, {
    key: "onFail",
